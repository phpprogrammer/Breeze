...
namespace system\libraries;
	...
	class lessc_parser {
		 ...
		 *
		 * Consider the function LessCompiler::keyword(). (all parse functions are
		 * structured the same)
		 *
		 ...
		 *
		 * All of these parse functions are powered by LessCompiler::match(), which behaves
		 ...
		 * avoid this, LessCompiler::seek() is used to remember and set buffer positions.
		 *
		...
		protected function literal($what, $eatWhitespace = true) {
			...
			return $this->match(LessCompiler::preg_quote($what), $m, $eatWhitespace);
		}
